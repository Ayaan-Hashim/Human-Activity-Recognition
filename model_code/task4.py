# TASK$: IMPROVING ON TASK 2 with the inclusion of gyroscope data
...
def create_segments_and_labels_1(df, window_size, overlap_size, label_col='physical_label'):
    segments = []
    labels = []
    df = df.drop(columns="activity_label")
